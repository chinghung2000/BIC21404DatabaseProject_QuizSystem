...
if (execute) {
	...
	if (true) {
		...
		HashMap<String, Object> lecturer = new HashMap<String, Object>();
		
		lecturer.put("lecturer_id", "1");
		lecturer.put("lecturer_name", "Chuah Chai Wen");
		...
		lecturer.put("modified_by", "Ahmad Syahmi");
		lecturer.put("modified_on", "21/4/2022 7:53:11 PM");
		result.add(lecturer);
