...
<script type="text/javascript">
	...
	function loadUserInfo(rc = null) {
		if (rc == null) {
			...
			$e("span-email").innerHTML = rc["email"];
		}
	}
</script>
<style type="text/css">
...
<body onload="loadUserInfo();">
	...
	<div class="menu">
		...
		<a href="registerSubjects.jsp"><button>Register Subjects</button></a>
		<a href="viewSubjects.jsp"><button>View Subjects</button></a>
		<button onclick="logout();">Log Out</button>
	</div>
	<div class="container">
		<div class="title">
			<span class="title">Student Homepage</span>
		</div>
		<br><br>
		<div class="content">
			Student ID: <span id="span-user-id"></span>
			<br><br>
			Name: <span id="span-name"></span>
			<br><br>
			Email: <span id=span-email></span>
			<br><br>
