...
<script type="text/javascript">
	...
	function edit(element, subjectId) {
		...
		input.type = "text";
		input.setAttribute("id", "input-subject-id-update");
		...
		input = document.createElement("input");
		input.type = "text";
		input.setAttribute("id", "input-subject-name-update");
		input.value = span.innerHTML;
		cell.appendChild(input);
		...
		button.setAttribute("onclick", "update($e('input-subject-id-update').value, $e('input-subject-name-update').value);");
